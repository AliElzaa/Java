...
public class ChristmasGift {
	...
	public static void main(String[] args) { //main function
		...
		String[] lastYear = {"y4", "x5", "x3", "x4", "y5", "y1", "y3", "y2", "x2", "x1"}; //this array holds last years couple but its exactly alligned with the first array "couples"
// the array couples[i] cant but for lastyear[i] in this array position
		...
		for (int counter = 0; counter < 10; counter++) { //makes a random draw 10 times
			...
			} while ((couples[counter].charAt(1) == couples[rnd].charAt(1)) || (couples[rnd] == lastYear[counter]) || (searchArray(recipients, couples[rnd]) == true));
...
//Second part of a loop makes sure the first position in array "couples" doesnt match the identical position in the other array, this removes the exclusion of last year
